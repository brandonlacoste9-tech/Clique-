...
const WEB_BG = "#0A0A0A";
const styleBlock = `<style>html,body{background:${WEB_BG}!important;margin:0;padding:0;min-height:100vh;height:100%;}body *{box-sizing:border-box;}#root,.root{background:${WEB_BG}!important;min-height:100vh!important;height:100%!important;display:flex!important;flex-direction:column!important;width:100%!important;}#root>*,.root>*{flex:1!important;min-height:100vh!important;display:flex!important;flex-direction:column!important;width:100%!important;}</style>`;
